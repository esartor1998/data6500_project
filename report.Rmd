...
#but... this "popd scaling raster" is completely insane and doesnt work LAWL
popd_scaling_rast = ad1300_popc_rast / ad1300_popd_rast
...
for (year in recorded_years) {
  ...
  prev_years_outbrks = target_years[which(target_years$year <= year),]
	...
	print(class(susc_tmp))
	print(class(susd_tmp))
...
#for (i in 1:length(susd)) {
  print(tm_shape(popd_scaling_rast) + 
          tm_raster())
#}
