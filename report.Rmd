...
ad1300_popc_rast = rast('./popc_1300AD.asc') %>%
                   ...
                   crop(up_cbbox) %>%
                   terra::project(projected_crs) #yes, this seems insane, but otherwise terra 
                                                 #downsamples to hell or crashes if you try to
...
for (year in recorded_years) {
  ...
  #the distance component of r_t. exponential decay based on (scaled) distance. scaled, shifted, and
  #tapered so that it is sane and reaches 0 at a "reasonable" distance 
  dist_rast =
