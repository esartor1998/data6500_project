...
```
  ...
  The nonparametric estimate of intensity as a function of population density also proved surprisingly validating.
...
legend("topleft", legend=paste0('Model #', most_corr_idx_P,
                               ' Final S. Pop. Correlation = ', round(correlations_P[[most_corr_idx_P]], 2)))
```
...
tm_shape(basemap) +
  ...
  tm_layout(legend.position=c('left', 'top'),
            frame=FALSE,
            legend.outside=TRUE,
            main.title=paste0('Model #',most_corr_idx_A,' Predicted Population in 1400AD'))
```
