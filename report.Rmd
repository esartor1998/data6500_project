...
### Deterministic Model Results
  ...
  Given the relative accuracy of the models, especially in higher-density areas, attention must be drawn instead to areas where the models lack accuracy. Ireland, Brittany, and particularly Southeastern Europe are all lacking some of the definition present in the HYDE 3.2 estimates. The deaths submodel in particular seems to have an excessively light hand in some rural areas. guesses: more complicated than just "max saturation", complicated not-just-distance relationship between urban/rural, likesaytradelol
