...
```{r focalCorrelationBetweenDeathsAndPopd, echo=FALSE, fig.cap='Pop. Dens. and Pop. Diff. Spatial Focal Correlation', out.height='80%'}
...
```{r predictedIntensityThroughRhohat, echo=FALSE, fig.cap='Nonparametric Estimate of Intensity as a Function of Pop. Dens.', out.height='80%'}
