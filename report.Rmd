...
```{r project_everything, echo=FALSE, include=FALSE}
```


```{r test, echo=FALSE}
tm_shape(basemap) + tm_rgb(alpha=0.7) + tm_shape(ad1300_popc_rast, raster.downsample = F) + tm_raster(alpha=0.7) + tm_shape(target_years) + tm_dots()
```
