...
dist_threshold = 0.01  #value at which we would like to round to 0, to prevent global infection
...
for (year in recorded_years) {
  ...
  plot(dist_rast, main=paste('dist_rast', year))
  ...
  infn_rast = (dist_rast * susd_tmp)
  plot(infn_rast, main=paste('infn_rast', year))
  
  #the estimate of the infected. should i use terra::predict, or...?
  infected[[curr_idx]] = floor(r0 * infn_rast * 10)
  ...
  susc_maps[[curr_idx]] = 
    ...
    tm_shape(susceptible[[curr_idx]], raster.downsample=F) +
      tm_raster(title='Estimated Susceptible',
                legend.show=T,
                breaks=c(0.0,
                         100.0,
                         200.0,
